...
public class Deck : MonoBehaviour
{
    ...
    void createDeck()
    {
        partsCardDeck = new List<Card>() {
            new Card("Angel's Head", "Head", "Rare", 0, 0, 0, "You've got someone watching over you", "Get rid of two body part curses", "Get a random curse and apply it to the opponent. Accuracy : 10", "None", "Divine", AngelsHead, "None", AngelsHeadPlayer),
            ...
            new Card("Brain in a Jar", "Head", "Rare", 0, 0, 0, "Alright brainiac...", "You may use 2 abilities in one turn as long as you do not move during that turn. You outsmarted your opponent, move 5-7 hexagons spaces behind the opponent. Accuracy 9", "You may use 2 abilities in one turn as long as you do not move during that turn. You outsmarted your opponent, move 5-7 hexagons spaces behind the opponent. Accuracy 9", "None", "Magical", BrainInAJar, "None", BrainInAJarPlayer),
            ...
            new Card("Centipede Leg", "Leg", "Uncommon", 0, -1, 1, "Just 299 legs short of a millipede.", "Gain an extra 3 speed for 1 turn. Accuracy 15", "Gain an extra 3 speed for 1 turn. Accuracy 15", "None", "Creature", CentipedeLegs, "None", CentipedeLegsPlayerL, CentipedeLegsPlayerR),
            ...
            new Card("Crab Claw", "Arm", "Uncommon", 0, 0, 0, "Protector of the sands", "Reduce your opponent's speed by 2 until the start of your next turn.", "Melee attack that deals 14 damage. Target gains -2 penalty to speed rolls until your next turn. Accuracy: 9", "None", "Creature", CrabClaw, "None", CrabClawPlayerL, CrabClawPlayerR),
            ...
            new Card("Death's Hood", "Head", "Legendary", 3, 0, 3, "One step closer...", "You may ignore an effect that causes you to lose body parts once. Use this to teleport to a empty \"Grave.\"", "You may teleport to the nearest available item space. Accuracy 12", "This head automatically equips and cannot be removed as long as this curse is active", "Divine", DeathsHood, "None", DeathsHoodPlayer),
            new Card("Dragon Head", "Head", "Rare", 0, 0, 0, "I am a dragon, hear me roar!", "Light three hexagans on fire around the map", "Combat Phase: Gain a fire breath that shoots 3 hexagons forward for 15 attack. Accuracy: 13 ", "None", "Mythical", DragonHead, "None", DragonHeadPlayer),
            new Card("Dullahan's Gauntlets", "Arm", "Rare", 0, 5, 0, "One has to take risks to get ahead", "Paralyze one of the legs from the opponent.  Accuracy 10", "Paralyze one of the legs from the opponent.  Accuracy 10", "You may not carry a head", "Dullahan", DullahansGauntlets, "None", DullahansGauntletsPlayerL, DullahansGauntletsPlayerR),
            new Card("Dullahan's Greaves", "Leg", "Rare", 15, 0, -1, "A curse is worth getting a leg up on the competition", "Paralyze one of the legs from the opponent.  Accuracy 10", "Paralyze one of the legs from the opponent.  Accuracy 10", "You may not carry a head", "Dullahan", DullahansGreaves, "None", DullahansGreavesPlayerL, DullahansGreavesPlayerR),
            ...
            new Card("Eldritch Void", "Torso", "Rare", 0, 0, 0, "Look into it, and you'll find something looking back at you", "Discard one held body part or item and draw a card to replace it.", "Discard one held body part or item and draw a card to replace it.", "None", "Mythical", EldritchVoid, "None", EldritchVoidPlayer),
            ...
            new Card("Gorgon Head", "Head", "Rare", 0, 0, 0, "At least let me get into a pose", "None", "Opponent gains -3 penalty to speed and attack dice rolls until your next turn. Accuracy: 15", "Upon obtaining, lose any other heads in inventory", "Mythical", GorgonHead, "None", GorgonHeadPlayer),
            ...
            new Card("Lich's Arm", "Arm", "Legendary", 0, 0, 0, "The runes etched in the bone are the key to its otherwordly power", "Lob dark energy at your foe slowing thier speed by 4 for the next turn", "Gain a dark magic range attack. Range: 5 hexes, Attack: 15, Accuracy: 10", "None", "Skeleton", LichsArm, "None", LichsArmPlayerL, LichsArmPlayerR),
            new Card("Lion Arm", "Arm", "Rare", 7, 7, 0, "Hear me roar!", "Disable one of your opponent's abilities of your choice as if they had used it", "Take thorn out of your paw. Healing for 10 health. Accuracy 10", "If basic attack, lost 1 health for 2 turns", "Creature", LionArm, "None", LionArmPlayerL, LionArmPlayerR),
            new Card("Metal Arm", "Arm", "Uncommon", 0, 2, -1, "The best technology money can buy", "If head to head in gathering face, punch the enemy and stun him for one turn", "You punch the opponent so hard, that they take 30 damage. Accuracy 7", "None", "Mythical", MetalArm, "None", MetalArmPlayerL, MetalArmPlayerR),
            ...
            new Card("Mirror Head", "Head", "Legendary", 0, 0, 0, "Look at you, look at me, what do you see?", "Use one of your opponent's abilities", "Use one of your opponent's abilities", "None", "Mythical", MirrorHead, "None", MirrorHeadPlayer),
            ...
            new Card("Pumpkin", "Head", "Common", 12, -2, 0, "Plump, ripe and orange", "Lob this head at the enemy cancelling thier next turn but lose this item", "Pumpkin seed ranged attack for 10 damage. Accuracy 15", "None", "Plant", Pumkin, "None", PumkinPlayer),
            new Card("Rabbit's Foot", "Leg", "Uncommon", 0, -2, 0, "Lucky you!", "Draw 1 item when discovered. Climb over an obstacle.", "If there is an item cache 5-7 hexagons, use this to get to the item cache. Accuracy 16", "None", "Creature", RabbitsFoot, "None", RabbitsFootPlayerL, RabbitsFootPlayerR),
            new Card("Sasquatch Leg", "Leg", "Rare", 14, -2, 0, "You never could sit still for the camera", "Gain 5 speed for one turn.", "Gain 5 speed for one turn.", "None", "Creature", SasquatchLeg, "None", SasquatchLegPlayerL, SasquatchLegPlayerR),
            ...
            new Card("Stoney Chest", "Torso", "Rare", 16, 0, -1, "For those hard of heart, and in tune with the earth", "None", "If head to head against opponent, give him a chest bump dealing 30 damage. Accuracy 8", "None", "Elemental", StoneyChest, "None", StoneyChestPlayer),
            new Card("Straw Head", "Head", "Common", -4, 2, 0, "Never underestimate the scarecrow", "Go to the nearest mound, works on both \"digged\" or not", "If your attack is lower than 7, increase next attack by 10, if not lower than 7, increase attack by 3. Accuracy 12", "None", "Scarecrow", StrawHead, "None", StrawHeadPlayer),
            new Card("Tentacle", "Arm", "Common", 0, 0, 0, "Calamari, anyone?", "If in a mound, draw an extra card", "Slap them in the face from afar based on your attack.  Accuracy: 12", "None", "Creature", Tentacle, "None", TentaclePlayerL, TentaclePlayerR),
            ...
            new Card("Werewolf Head", "Head", "Legendary", 10, 0, 2, "Looks like meat's back on the menu!", "You may consume 1 body part per turn to increase health by 10. Accuracy: 16", "You may consume 1 body part per turn to increase health by 10. Accuracy: 16", "None", "Mythical", WerewolfHead, "None", WerewolfHeadPlayer),
            new Card("Wings", "Torso", "Rare", 0, 0, 0, "Take to the skies!", "Can pass over obstacles without using an action. Push the enemy 4 hexagons in any direction", "If 5 hexagons away, use range wind attack that deals 12 damage. Accuracy: 10. Otherwise, use wind attack based off your attack. Accuracy: 8", "None", "Mythical", Wings, "None", WingsPlayer),
